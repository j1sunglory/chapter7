...
class MainActivity : AppCompatActivity(), WordAdapter.ItemClickListener  {
    ...
    private fun initRecyclerView() {
        ...
        binding.wordRecyclerView.apply {
            ...
            layoutManager = LinearLayoutManager(applicationContext, LinearLayoutManager.VERTICAL, false) // 레이아웃 매니저 설정
    ...
    private fun delete() {
        ...
        Thread {
            selectedWord?.let { word -> AppDatabase.getInstance(this)?.wordDao()?.delete(word)
            runOnUiThread {
